...
class PortScannerFrame(ctk.CTkFrame):
    def __init__(self, parent, hover, tooltips, descriptions):
        ...
        label_target.bind("<Enter>", lambda event: hover.display(tooltips["ps_target"]))
        ...
        label_start.bind("<Enter>", lambda event: hover.display(tooltips["ps_s_port"]))
        ...
        label_end.bind("<Enter>", lambda event: hover.display(tooltips["ps_e_port"]))
        ...
        textbox_description.insert("end", descriptions["port_scan"])
